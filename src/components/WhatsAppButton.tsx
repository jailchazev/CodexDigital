...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className="absolute right-full mr-4 px-4 py-2 bg-gray-800 text-white rounded-lg whitespace-nowrap text-sm font-medium shadow-lg">
          ¿Necesitas ayuda? Chatea con nosotros
          <div className="absolute top-1/2 -right-2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-l-8 border-l-gray-800" />
        </div>
      )}
